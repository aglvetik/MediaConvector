...
class MediaCacheModel(Base):
    ...
    resource_type: Mapped[str] = mapped_column(String(32), nullable=False, default="video", index=True)
    ...
    photo_file_unique_ids: Mapped[str | None] = mapped_column(Text, nullable=True)
