...
from app.domain.errors import AudioExtractionError, InvalidCachedMediaError, MediaTooLargeError, NormalizationError, TelegramDeliveryError
...
class FakeGateway:
    def __init__(self, *, max_file_size_bytes: int = 50 * 1024 * 1024) -> None:
        ...
        self.loading_messages: list[tuple[int, int]] = []
    ...
    async def send_loading_message(self, chat_id: int, reply_to_message_id: int | None = None) -> int:
        ...
        self.loading_messages.append((chat_id, self.next_message_id))
